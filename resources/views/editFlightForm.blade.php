      ...
      <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
        ...
        <div class="-mx-3 md:flex mt-2 flex flex-col flex-wrap justify-center items-center mg-0-auto">
          <div class="md:w-full px-3 flex justify-center space-x-4">
            <button action="{{ route('flightUpdate', ['id' => $flight->id]) }}" type="submit" class="md:w-1/3 bg-blue-500 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-blue-200 hover:border-gray-100 rounded-full">
              Edit
            </button>
