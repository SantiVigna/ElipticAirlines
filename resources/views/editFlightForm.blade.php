...
<div class="bg-gray-100 mx-auto max-w-6xl bg-white py-20 px-12 lg:px-24 shadow-xl mb-24 mt-24 rounded-lg">
    <div class="flex flex-col items-center ">
        <div class="mb-10">
            ...
            <p class="text-gray-600 text-center">Form to edit a Flight</p>
        </div>
    <form action="{{ route('flightUpdate', ['id' => $flight->id]) }}" method="POST">
        @method('patch')
        @csrf
      <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
        <div class="-mx-3 md:flex mb-6">
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="flight_number" name="flight_number" type="text" placeholder="ES-Z82" value="{{ $flight->flight_number}}">
            <div>
          ...
          <div class="md:w-1/2 px-3">
            ...
            <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="price" name="price" type="number" placeholder="86" value="{{ $flight->price}}">
          </div>
        </div>
        <div class="-mx-3 md:flex mb-2">
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <div>
              <select class="w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded" id="departure" name="departure" value="{{ $flight->departure}}">
          ...
          <div class="md:w-1/2 px-3">
            ...
            <div>
              <select class="w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded" id="arrival" name="arrival" value="{{ $flight->arrival}}">
                <option value="Barcelona">Barcelona</option>
                <option value="Paris">Paris</option>
                <option value="Rome">Rome</option>
                <option value="Berlin">Berlin</option>
          ...
          <div class="md:w-1/2  px-3">
            ...
            <div>
              <select class="w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded" id="airplane_id" name="airplane_id" type="text" value="{{ $flight->airplane_id}}">
        ...
        <div class="-mx-3 md:flex mb-2 mt-4">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <div>
                <select class="w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded" id="departure_time" name="departure_time" value="{{ $flight->departure_time}}">
            ...
            <div class="md:w-1/2 px-3">
              ...
              <div>
                <select class="w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded" id="arrival_time" name="arrival_time" value="{{ $flight->arrival_time}}">
                    <option value="13/02/2025">13/02/2025</option>
                    <option value="14/02/2025">14/02/2025</option>
                    <option value="15/02/2025">15/02/2025</option>
                    <option value="16/02/2025">16/02/2025</option>
            ...
            <div class="md:w-1/2 px-3">
                ...
                <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" id="distance" name="distance" type="number" placeholder="86" value="{{ $flight->distance}}">
            </div>
          </div>
        <div class="-mx-3 md:flex mt-2 flex flex-col flex-wrap justify-center items-center mg-0-auto">
          <div class="md:w-full px-3 flex justify-center space-x-4">
            <button action="{{ route('flightUpdate', ['id' => $flight->id]) }}" type="submit" class="md:w-1/3 bg-green-500 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-green-200 hover:border-gray-100 rounded-full">
              Edit
            </button>
