            ...
            <div class="bg-white rounded-lg p-6 shadow">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Torremolinos, Malaga</p>
                        <p class="text-gray-600 text-sm">El Pinillo, 29620</p>
                    </div>
                </div>
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">+34 630 00 90 88</p>
                    </div>
                </div>
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">ynotvigna@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
